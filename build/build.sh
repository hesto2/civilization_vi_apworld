...
#     eg: "v1.1.1" will name the bundle "civ6_apworld-v1.1.1"
...
function mk_apworld() {
    ...
    rsync --progress \
        ...
        "${root}/" "${destdir}/civ6"
    pushd "${destdir}"
    zip -9r "civ6.apworld" "civ6"
    popd

    rm --force --recursive "${destdir}/civ6"
}
...
function main() {
    ...
    local bundle_base="civ6_apworld"
